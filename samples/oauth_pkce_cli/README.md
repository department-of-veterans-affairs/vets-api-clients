...
Options:
  ...
  -a, --auth_server <auth server url>            ex: https://sandbox-api.va.gov/oauth2/veteran-verification-apis/v1 (default: "")
...
./pkce-cli \
  ...
  --auth_server https://sandbox-api.va.gov/oauth2/veteran-verification-apis/v1 \
